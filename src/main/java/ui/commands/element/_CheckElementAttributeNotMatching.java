...
public class _CheckElementAttributeNotMatching implements Command<CustomSelenideElement> {

    @Override
    @Nonnull
    public CustomSelenideElement execute(SelenideElement proxy, WebElementSource locator, @Nullable Object[] args) {
        CommonPageHelper.checkElementAttributeNotMatching(proxy, getElementAliasName(proxy), (Attribute) requireNonNull(args)[0], (String) requireNonNull(args)[1]);
