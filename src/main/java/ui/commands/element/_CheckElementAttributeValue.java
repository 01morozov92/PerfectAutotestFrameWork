...
public class _CheckElementAttributeValue implements Command<CustomSelenideElement> {

    @Override
    @Nonnull
    public CustomSelenideElement execute(SelenideElement proxy, WebElementSource locator, @Nullable Object[] args) {
        CommonPageHelper.checkElementAttributeValue(proxy, getElementAliasName(proxy), (Attribute) requireNonNull(args)[0], (String) requireNonNull(args)[1]);
